...
export const API_ENDPOINTS = {
  ...
  ATTENDANCE: {
    ...
    UPLOAD_ATTENDANCE_PHOTO: '/kiosk/attendance/upload-attendance-photo',
    V3_UPLOAD_PHOTO: '/kiosk/attendance/upload-attendance-photo',
    CANCEL: '/kiosk/attendance/cancel',
