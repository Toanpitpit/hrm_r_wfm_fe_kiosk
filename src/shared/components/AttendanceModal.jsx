  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/85 backdrop-blur-md animate-fade-in">
      <div className={`w-full max-w-md p-8 rounded-3xl shadow-2xl border text-center relative overflow-hidden transition-all transform scale-100 ${
        ...
        {/* Top Indicator Bar */}
        <div className={`h-2 w-full absolute top-0 left-0 ${isSuccess ? 'bg-emerald-500' : 'bg-red-500'}`} />
        ...
        {/* Status Title */}
        <h2 className={`text-2xl font-black uppercase tracking-wider ${isSuccess ? 'text-emerald-400' : 'text-red-400'}`}>
